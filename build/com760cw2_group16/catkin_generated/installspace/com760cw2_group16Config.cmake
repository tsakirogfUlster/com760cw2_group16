...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'com760cw2_group16' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fotis/Documents/ulster/com760cw2_group16/install/lib;/home/fotis/Documents/ulster/com760cw2_group16/devel/lib;/opt/ros/kinetic/lib)
...
set(com760cw2_group16_EXPORTED_TARGETS "")
